...
$wp_store_recommended_plugins = array(
	...
	<div class="feature-section recommended-plugins">
		...
		switch ( $active['needs'] ) {
			...
			$label = esc_html__( 'Install', 'wp-store' );
			break;
			case 'activate':
		...
		<div class="col plugin_box">
			<?php if ( $prop['recommended'] ): ?>
				<span class="recommended"><?php esc_html_e( 'Required', 'wp-store' ); ?></span>
			<?php endif; ?>
			...
			<div class="b-wrap">
			<span class="version"><?php echo esc_html__( 'Version:', 'wp-store' ); ?><?php echo esc_html( $info->version ) ?></span>
